...
function get_code_and_data_to_local() {
   ...
   #cp -r ${PARSER}/bin/* $ONE_TASK_PRODUCT_NEW/itlg-ec1/bin 
   #cp -r ${PARSER}/bin/* $ONE_TASK_PRODUCT_NEW/itlg-ec2/bin 
   #cp -r ${PARSER}/conf/* $ONE_TASK_PRODUCT_NEW/itlg-ec1/conf 
   #cp -r ${PARSER}/conf/* $ONE_TASK_PRODUCT_NEW/itlg-ec2/conf
   ...
   wget_ftp  $define_data_ftp_path $ONE_TASK_COMMON_DATA_PATH "common_input"
   echo "wget common_input success"
