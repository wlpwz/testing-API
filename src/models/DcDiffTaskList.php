 ...
 */
class DcDiffTaskList extends CActiveRecord
{
        public $sort_default;
        /**
        ...
        public function rules()
        {
                ...
                return array(
                        ...
                        array('diff_task_id,time,user,log_path, host_name, status, mission_description,language,new_input_path,old_input_path', 'safe', 'on'=>'search'
                         ),
                );
        }
