 ...
 */
class EcTaskList extends CActiveRecord
{
        public $sort_default;
        /**
        ...
        public function rules()
        {
                ...
                return array(
                        ...
                        array('id,task_name , time, task_type, new_output_path, old_output_path, new_version, old_version, user, log_path, host_name, status, new_module_list, old_module_list', 'safe', 'on'=>'search'
                         ),
                );
        }
