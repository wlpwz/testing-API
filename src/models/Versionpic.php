 ...
 */
class Versionpic extends CActiveRecord
{
//        public $sort_default;
        /**
        ...
        public function rules()
        {
                ...
                return array(
                        ...
                        array('nodename,linkname,url,tooltip', 'safe', 'on'=>'search'
                         ),
                );
        }
...
/*
  ...
  */      /**
        ...
        public function search()
        {
                ...
                $criteria->compare('nodename',$this->nodename);
                $criteria->compare('url',$this->url,true);
				$criteria->compare('linknode',$this->linknode,true);
