 ...
 */
class EcRunTaskList extends CActiveRecord
{
        public $sort_default;
        /**
        ...
        public function search()
        {
                ...
                $criteria->compare('run_task_id',$this->run_task_id);
                $criteria->compare('time',$this->time,true);
                $criteria->compare('user',$this->user,true);
                $criteria->compare('related_run_id',$this->related_run_id,true);
                $criteria->compare('diff_id',$this->diff_id,true);
                $criteria->compare('log_path',$this->log_path, true);
				$criteria->compare('host_name',$this->host_name, true);
                $criteria->compare('run_path',$this->run_path, true);
                $criteria->compare('status',$this->status,true);
				$criteria->compare('bin_output_new',$this->bin_output_new,true);
				$criteria->compare('bin_output_old',$this->bin_output_old,true);
				$criteria->compare('ec_type',$this->ec_type,true);
				$criteria->compare('conf_new',$this->conf_new,true);
				$criteria->compare('conf_old',$this->conf_old,true);
				$criteria->compare('input_path',$this->input_path, true);
				$criteria->compare('input_num',$this->input_num, true);
