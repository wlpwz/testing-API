...
<br>
    ...
    <div class="row-fluid">
        ...
        <span class="span4">
                <?php echo $form->textField($model,'diff_task_id'); ?>
        </span>
        <span class="span2">
    ...
    <div class="row-fluid">
        <span class="span2">
        <?php echo $form->label($model,'new_input_path'); ?>
        </span>
        <span class="span4">
        <?php echo $form->textField($model,'new_input_path',array('size'=>50,'maxlength'=>50)); ?>
        </span>
        <span class="span2">
        <?php echo $form->label($model,'old_input_path'); ?>
        </span>
        <span class="span4">
        <?php echo $form->textField($model,'old_input_path',array('size'=>50,'maxlength'=>50)); ?>
        </span>
    </div>
