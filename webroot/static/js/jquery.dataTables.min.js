...
this.aanFeatures=[];this.oLanguage={sProcessing:"处理中...",sLengthMenu:"每页显示 _MENU_ 条记录",sZeroRecords:"未找到符合条件的记录",sInfo:"当前显示 _START_ 到 _END_ ( 共 _TOTAL_ 条记录 )",sInfoEmpty:"当前显示 0 到 0 ( 共 0 条记录 )",sInfoFiltered:" ( 共过滤 _MAX_ 条记录 )",sInfoPostFix:"",sSearch:"过滤:",sUrl:"",oPaginate:{sFirst:"第一页",sPrevious:"上一页",sNext:"下一页",sLast:"最后一页"}};
