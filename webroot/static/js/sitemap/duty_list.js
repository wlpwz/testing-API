(function(){
	...
	StatTypeList.prototype.renderDialBox = function(obj){
		if($('.dialogue').length == 0) {
			...
			html += '<div class="controls"><input id="type_time" class="span2 inline" size="50" type="text" value="' + obj.create_time+ '" />';
			html += '</div></div>';
			html += '<div class="control-group">';
			html += '<label class="control-label">姓名</label>';
			html += '<div class="controls"><input id="type_name" class="span2 inline" name="name" size="50" maxlength="100" type="text" placeholder="" value="' + obj.name + '" required>';
			html += '</div>';
			html += '</div>';
			html += '<div class="control-group">';
			html += '<label class="control-label">Hi</label>';
			html += '<div class="controls"><input id="type_hi" class="span2 inline" name="hi" size="50" maxlength="100" type="text" placeholder="" value="' + obj.hi + '" required>';
			html += '</div>';
			html += '</div>';
      html += '<div class="control-group">';
      html += '<label class="control-label">邮箱</label>';
      html += '<div class="controls"><input id="type_email" class="span2 inline" name="email" size="50" maxlength="100" type="text" placeholder="" value="' + obj.email + '" required>';
      html += '</div>';
      html += '</div>';
