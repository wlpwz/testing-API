...
(function ( global ) {
    ...
    function appendScript( script ) {
		...
		//var isJquery = false || document.createElement(script.outerHTML).getAttribute("data-require-id");	
        var doc = document;
		//isJquery = false || $(script.outerHTML).attr("data-require-id");	
		isJquery = false || script.attributes[0].nodeValue == "jquery";
		if(!isJquery) (doc.getElementsByTagName('head')[0] || doc.body).appendChild( script );
